...
# @pytest.mark.parametrize('promo_num', [1,2,3,4,5,6,pytest.param(7, marks=pytest.mark.xfail(reason="bug")),8,9])
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    page.go_to_basket()
    basket_page = BasketPage(browser, browser.current_url)
    basket_page.should_have_no_items()
